...
RSpec.describe Product, type: :model do
  ...
  describe ".recent" do
    ...
    it "returns the most recently updated record" do
      expect(Product.recent).to match_array([@product2, @product3, @product4, @product1])
    end
  end
  ...
  describe ".search" do
    ...
    context "when title 'videogame' and '100' min price are set" do
    ...
    context "when title 'tv', '150' as a max price, and '50' as min price are set" do
